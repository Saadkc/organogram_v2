...
Future<T?> showOrgNodeSearch<T>({
  required BuildContext context,
  required NodeSearchDelegate<T> delegate,
  String? query = '',
...
abstract class NodeSearchDelegate<T> {
...
class _SearchPageRoute<T> extends PageRoute<T> {
  ...
  final NodeSearchDelegate<T> delegate;
    ...
    return Semantics(
      ...
      child: Theme(
        ...
        child: Dialog(
          ...
          elevation: 60,
          insetPadding:
              const EdgeInsets.symmetric(horizontal: 0, vertical: 100),
          child: SizedBox(
